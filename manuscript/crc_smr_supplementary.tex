...
IVW, weighted median, weighted mode and MR-Egger slope estimates with 95\% CI for the five genes
shown (CCM2, LIMA1, STAT6, CDKN1A, TNF). MR-Egger slope accounts for directional pleiotropy; qualitatively consistent
directions across methods support a robust causal estimate. The four further genes carrying cis-pQTL
instruments (TNFRSF1A, NCF2, TNFRSF1B, LTA) are summarized in Table~3.}
\label{fig:S26}
\end{figure}
...
Per-SNP Wald-ratio causal estimate versus instrument precision (1/SE) for the five genes shown
(CCM2, LIMA1, STAT6, CDKN1A, TNF);
...
MR-PRESSO flagged 5 (TNFRSF1A), 3 (NCF2), 5 (STAT6), 10 (LIMA1), 15 (CCM2) and 22 (CDKN1A) outlier
instruments. Removing them left the two strongest protein-level signals (CCM2, LIMA1) intact and
larger in magnitude and left STAT6 null and CDKN1A essentially unchanged, but reversed the sign of
the NCF2 estimate, for which no direction is therefore interpreted (Table~3). No instrument was
flagged for TNFRSF1B, whose global test was not significant ($p = 0.997$).}
\label{fig:S27}
\end{figure}
...
across 3{,}493 Visium spots; ME6 Stromal cells was the largest zone (927 spots, 26.5\%),
...
\input{manuscript/tables/TableS6_me_zone_characterization.tex}
\clearpage
\input{manuscript/tables/TableS7_spatial_crosscorrelation.tex}
\input{manuscript/tables/TableS8_phewas_safety.tex}
\clearpage
\input{manuscript/tables/TableS9_chen2024_gene_list.tex}
\input{manuscript/tables/TableS10_steiger.tex}
