...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{FigS23_tier1_regional_plots.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{FigS2_smr_or_forest.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{FigS6_mr_sensitivity.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{FigS4_ukbppp_pqtl_coloc.pdf}
\caption{\textbf{UKB-PPP pQTL colocalization.}
Forest plot of coloc.abf PPH4 values for $n = 5$ UKB-PPP pQTL--GWAS colocalization tests. All genes failed
coloc (PPH4 $<$ 0.8).}
\label{fig:S4}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{FigS5_decode_pqtl_coloc.pdf}
\caption{\textbf{deCODE pQTL colocalization.}
Forest plot of coloc.abf PPH4 values for $n = 5$ deCODE pQTL--GWAS colocalization tests
(LIMA1, CCM2, STAT6, TNFRSF1A, TNFRSF1B). Only CCM2 passed
coloc (PPH4 = 0.9514).}
\label{fig:S5}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{FigS20_pqtl_mr_decode_forest.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{FigS21_pqtl_mr_ukbppp_forest.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{FigS24_pqtl_mr_scatter.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{FigS25_pqtl_mr_loo.pdf}
\caption{\textbf{pQTL MR leave-one-out sensitivity.}
IVW causal estimate after sequentially dropping each instrument (red triangle = all instruments),
showing robustness of the estimate to any single instrument for the five pQTL MR genes.}
\label{fig:S25}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{FigS26_pqtl_mr_methods_forest.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{FigS27_pqtl_mr_funnel_pleiotropy.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{FigS7_celltype_dotplot.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.70\textwidth]{FigS8_spatial_TMBIM1.pdf}
\caption{\textbf{Spatial expression of TMBIM1 in CRC tissue.}
Visium spatial expression of TMBIM1 across $n = 3{,}493$ spots; TMBIM1 was detected in 57\% of
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{FigS22_finngen_replication_forest.pdf}
...
\input{manuscript/tables/TableS1_smr_top10.tex}
\input{manuscript/tables/TableS2_protein_coding.tex}
\input{manuscript/tables/TableS3_susie_sensitivity.tex}
\input{manuscript/tables/TableS4_ukbppp_pqtl_coloc.tex}
\input{manuscript/tables/TableS5_decode_pqtl_coloc.tex}
\input{manuscript/tables/TableS7_me_zone_characterization.tex}
\clearpage
\input{manuscript/tables/TableS9_spatial_crosscorrelation.tex}
\input{manuscript/tables/TableS6_phewas_safety.tex}
\clearpage
\input{manuscript/tables/TableS8_chen2024_gene_list.tex}
