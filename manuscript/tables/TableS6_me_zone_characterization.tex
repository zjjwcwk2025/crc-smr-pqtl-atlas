\begin{table}[htbp]
\centering
\caption{Microenvironment (ME) zone characterization via K-means clustering (k=6, elbow method) of cell-type module scores on 3493 Visium spots (GSE285505).}\label{tab:me_zones}
\small
