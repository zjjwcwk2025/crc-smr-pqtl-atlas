...
(Wald $b = -0.295$).  However, none of the 5 genes showed pQTL--GWAS colocalization (max PPH4 = 0.275 for TNF; Supplementary Table~S4; Supplementary Fig.~S6).
...
cis-pQTL instruments are reported in Supplementary Figs.~S8--S9 and
Supplementary Figs.~S10--S13. Every instrument in all 17 gene--dataset
